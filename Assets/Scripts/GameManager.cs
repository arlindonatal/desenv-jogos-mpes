...
/*		Object Enemy15 = Instantiate(enemy, new Vector3(118, 3, 5), Quaternion.identity);
	...
	Object Enemy7 = Instantiate(enemy, new Vector3(140, 3, 0), Quaternion.identity);
		...
		Object Enemy17 = Instantiate(enemy, new Vector3(120, 3, 3), Quaternion.identity);
		Object Enemy18 = Instantiate(enemy, new Vector3(140, 3, 3), Quaternion.identity);
		Object Enemy19 = Instantiate(enemy, new Vector3(150, 3, 3), Quaternion.identity);

		Object Enemy20 = Instantiate(enemy, new Vector3(120, 3, 5), Quaternion.identity);
		Object Enemy21 = Instantiate(enemy, new Vector3(140, 3, 5), Quaternion.identity);
		Object Enemy22 = Instantiate(enemy, new Vector3(150, 3, 5), Quaternion.identity);*/
	

		Object Enemy23 = Instantiate(enemy, new Vector3(50, 7, 3), Quaternion.identity);
		Object Enemy24 = Instantiate(enemy, new Vector3(40, 7, 3), Quaternion.identity);
		Object Enemy25 = Instantiate(enemy, new Vector3(80, 3, 3), Quaternion.identity);
//		Object Enemy26 = Instantiate(enemy, new Vector3(118, 3, 3), Quaternion.identity);
		//Object Enemy27 = Instantiate(enemy, new Vector3(100, 3, 3), Quaternion.identity);

		Object Enemy28 = Instantiate(enemy, new Vector3(50, 7, 5), Quaternion.identity);
		Object Enemy29 = Instantiate(enemy, new Vector3(40, 7, 5), Quaternion.identity);
		Object Enemy30 = Instantiate(enemy, new Vector3(80, 3, 5), Quaternion.identity);
		//Object Enemy31 = Instantiate(enemy, new Vector3(118, 3, 5), Quaternion.identity);
//		Object Enemy32 = Instantiate(enemy, new Vector3(100, 3, 5), Quaternion.identity);
